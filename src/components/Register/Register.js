...
class Register extends Component {
  render() {
    return (
      <div className="page_register component_container bg_ptrn">
        <div className="container">
				  <div className="bg_white col-md-6">
            <div className="row">
								...
								<div className="col-md-8">
									<form className="form-inline">
										...
										<div className="btn_signup">
											<button type="submit" className="btn btn-block" value="submit" >가입 완료</button>
										</div>
									</form>
								</div>
							</div>
